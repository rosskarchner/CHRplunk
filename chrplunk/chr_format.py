...
# Default 4-color palette using actual NES 2C02 colors
# Grayscale gradient commonly used for tile editing
NES_PALETTE = [
    (0, 0, 0),         # $0F - Black
    (124, 124, 124),   # $00 - Dark gray
    (188, 188, 188),   # $10 - Light gray
    (252, 252, 252),   # $30 - White
]

# Full NES 2C02 system palette (52 colors + 4 duplicates for 64 entries)
# These are the hardware colors games can choose from
NES_SYSTEM_PALETTE = [
